...
// const red = movements.reduce((acc, cur) => acc + cur, 0);
...
//     if (mov > 0) {
//         console.log(`Movement ${i + 1}: You are deposited ${mov}`);
//     } else {
//         console.log(`Movement ${i + 1}: You are withdrew ${mov}`);
//     }
// });
...
//     const humanAgeArr = arr.map((age, i) => {
//         if (age <= 2) return 2 * age;
//         else return 16 + age * 4;
//     });
//     console.log(humanAgeArr);
//     const adults = humanAgeArr.filter((age) => age >= 18);
//     console.log(adults);
...
if (sarahDog.curFood > sarahDog.recommendedFood * 1.1)
    ...
    else console.log(`Sarah's dog eats OK`);
